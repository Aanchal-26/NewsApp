...
const News = (props) => {
    ...
    return (
        <>
            ...
            {loading && <Spinner />}
            <InfiniteScroll
                dataLength={articles ? articles.length : 0} // Add a safe check for articles
                next={fetchMoreData}
...
News.propTypes = {
    ...
    apiKey: PropTypes.string.isRequired, // Ensure apiKey is passed as prop
    setProgress: PropTypes.func.isRequired, // Ensure setProgress is passed as prop
}
